const appList = [
  {
    ...
    description:
      "A simple to-do list web app to plan your day. Inspired by Microsoft Todo with different style. Built on basic HTML, CSS and Vanilla JavaScript.",
  },
  {
    title: "Contacts",
    ...
    description:
      "Contact storing app. A personal Yellow Pages everyone can use. Inspired by Google Contacts. Built on basic HTML, CSS and Vanilla JavaScript",
  },
  {
    title: "Janken Battle",
